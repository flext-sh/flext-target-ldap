...
_LAZY_IMPORTS = merge_lazy_imports(
    ...
    {
        "FlextTargetLdap": ".target",
        "FlextTargetLdapAuthenticationError": ".errors",
        "FlextTargetLdapConfigurationError": ".errors",
        "FlextTargetLdapConnectionError": ".errors",
        "FlextTargetLdapConstants": ".constants",
        "FlextTargetLdapError": ".errors",
        "FlextTargetLdapModels": ".models",
        "FlextTargetLdapProcessingError": ".errors",
        "FlextTargetLdapProtocols": ".protocols",
        "FlextTargetLdapService": ".api",
        "FlextTargetLdapSettings": ".settings",
        "FlextTargetLdapTimeoutError": ".errors",
        "FlextTargetLdapTypes": ".typings",
        "FlextTargetLdapUtilities": ".utilities",
        "FlextTargetLdapValidationError": ".errors",
        ...
        "build_singer_catalog": ".catalog",
        "c": (".constants", "FlextTargetLdapConstants"),
        "d": ("flext_core.decorators", "FlextDecorators"),
        "e": ("flext_core.exceptions", "FlextExceptions"),
        "h": ("flext_core.handlers", "FlextHandlers"),
        "m": (".models", "FlextTargetLdapModels"),
        "p": (".protocols", "FlextTargetLdapProtocols"),
        "r": ("flext_core.result", "FlextResult"),
        "s": (".api", "FlextTargetLdapService"),
        "t": (".typings", "FlextTargetLdapTypes"),
        "u": (".utilities", "FlextTargetLdapUtilities"),
