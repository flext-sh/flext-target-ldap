...
for Oracle-to-LDAP migration scenarios, ported from algar-oud-mig
...
class OidDataClassifier:
    ...
    Ported from algar-oud-mig to provide intelligent classification
...
class DataTransformationEngine:
    ...
    Ported from algar-oud-mig to provide enterprise-grade transformation
