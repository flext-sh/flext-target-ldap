# FLEXT-TARGET-LDAP Makefile - Data Integration Pipeline
# =========================================================
...
help: ## Show this help message
	@echo "🏗️  Flext Target Ldap - Data Integration Pipeline"
	@echo "==============================================="
	@grep -E '^[a-zA-Z_-]+:.*?## .*$$' $(MAKEFILE_LIST) | sort | awk 'BEGIN {FS = ":.*?## "}; {printf "\033[36m%-20s\033[0m %s\n", $$1, $$2}'

# Installation & Setup
install: ## Install dependencies with Poetry
	@echo "📦 Installing dependencies for flext-target-ldap..."
...
# Testing
test: ## Run tests
	@echo "🧪 Running tests for flext-target-ldap..."
	@if [ -d tests ]; then \
...
test-coverage: ## Run tests with coverage
	@echo "🧪 Running tests with coverage for flext-target-ldap..."
	@python -m pytest tests/ --cov=src --cov-report=html --cov-report=term

# Code Quality - Maximum Strictness
lint: ## Run all linters with maximum strictness
	@echo "🔍 Running maximum strictness linting for flext-target-ldap..."
...
type-check: ## Run strict type checking
	...
	poetry run mypy src/flext_target_ldap --strict --show-error-codes
...
check: lint type-check security test ## Run all quality checks
	@echo "✅ All quality checks complete for flext-target-ldap!"

# Build & Distribution
build: ## Build the package with Poetry
	@echo "🔨 Building flext-target-ldap package..."
	poetry build
	@echo "📦 Package built successfully"

build-clean: clean build ## Clean then build
	@echo "🔄 Clean build for flext-target-ldap..."
...
publish: build ## Publish to PyPI
	@echo "🚀 Publishing flext-target-ldap to PyPI..."
	poetry publish

# Documentation
docs: ## Generate documentation
	@echo "📚 Generating documentation for flext-target-ldap..."
...
clean: ## Clean build artifacts
	@echo "🧹 Cleaning build artifacts for flext-target-ldap..."
...
dev-setup: install-dev ## Complete development setup
	@echo "🎯 Setting up development environment for flext-target-ldap..."
	poetry run pre-commit install
	mkdir -p reports
	@echo "✅ Development setup complete!"

dev: ## Run in development mode
	@echo "🔧 Starting flext-target-ldap in development mode..."
	PYTHONPATH=src poetry run python -m flext_target_ldap --debug
...
export FLEXT_TARGET_LDAP_DEV := true
