...
# Access LDAP admin interface at http://localhost:20080 (phpLDAPadmin)
...
- `docker-compose.yml` - LDAP test servers (source:20389, target:21389) and phpLDAPadmin:20080
- Uses `osixia/openldap:1.5.0` and `osixia/phpldapadmin:0.9.0` images
