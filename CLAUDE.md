...
python -m target_ldap --debug test-connection \
  --ldap-host localhost \
  --ldap-port 389 \
  --bind-dn "cn=REDACTED_LDAP_BIND_PASSWORD,dc=test,dc=com" \
...
# ldapsearch -h localhost -p 389 -D "cn=REDACTED_LDAP_BIND_PASSWORD,dc=test,dc=com" -w "password"  # FORBIDDEN
# ldapadd -h localhost -p 389 -D "cn=REDACTED_LDAP_BIND_PASSWORD,dc=test,dc=com" -w "password"     # FORBIDDEN
# ldapmodify -h localhost -p 389 -D "cn=REDACTED_LDAP_BIND_PASSWORD,dc=test,dc=com"                # FORBIDDEN
...
class FlextLdapTargetService(FlextDomainService[FlextResult[LdapTargetResult]]):
    ...
    def orchestrate_ldap_data_loading(
        ...
        Example:
            ...
            ... ]
            >>> ldap_config = {"host": "ldap.company.com", "bind_dn": "cn=REDACTED_LDAP_BIND_PASSWORD", "bind_password": "secret"}
