# CLAUDE.local.md - TARGET-LDAP PROJECT SPECIFICS
...
export TARGET_LDAP_BIND_DN="cn=admin,dc=company,dc=com"
export TARGET_LDAP_PASSWORD=secure_admin_password
...
- **algar-oud-mig**: Target for Oracle Directory migration
