...
- Primary facades: `FlextTargetLdapAuthenticationError`, `FlextTargetLdapEntryManager`, `FlextTargetLdapUsersSink`, `FlextTargetLdapBaseSink`, `FlextTargetLdapDataTransformer`, `FlextTargetLdapProcessingError` (+31 more)
