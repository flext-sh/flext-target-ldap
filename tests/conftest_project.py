...
@pytest.fixture
def mock_ldap_config() -> FlextCore.Types.Dict:
...
@pytest.fixture
def sample_user_record() -> FlextCore.Types.Dict:
    """Create mock LDAP configuration for testing."""
    return {
...
@pytest.fixture
def sample_group_record() -> FlextCore.Types.Dict:
    """Create mock LDAP configuration for testing."""
    return {
...
@pytest.fixture
def sample_ou_record() -> FlextCore.Types.Dict:
    """Create mock LDAP configuration for testing."""
    return {
...
@pytest.fixture
def singer_message_record(sample_user_record: FlextCore.Types.Dict) -> str:
    """Create mock LDAP configuration for testing."""
    message = {
        "type": "RECORD",
        "stream": "users",
...
@pytest.fixture
def mock_target(mock_ldap_config: FlextCore.Types.Dict) -> MagicMock:
    """Create mock LDAP configuration for testing."""
    target = MagicMock()
