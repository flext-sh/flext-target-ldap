...
class TestCompleteLDAPWorkflow:
    ...
    def production_config(self):
        ...
        return TargetConfig(
            ...
            bind_password="prod_admin_password",
    ...
    async def test_complete_directory_migration(self, production_config):
        ...
        directory_data = {
            ...
            "users": [
                {"uid": "admin", "cn": "Administrator", "sn": "Admin", "mail": "admin@company.com"},
                {"uid": "user1", "cn": "User One", "sn": "One", "mail": "user1@company.com"}
            ],
            "groups": [
                {"cn": "administrators", "objectClass": ["groupOfNames"], "member": ["uid=admin,ou=users,dc=company,dc=com"]},
...
def test_config():
    ...
    return TargetConfig(
        ...
        bind_dn=os.getenv("TEST_BIND_DN", "cn=admin,dc=example,dc=com"),
        bind_password=os.getenv("TEST_BIND_PASSWORD", "admin_password"),
