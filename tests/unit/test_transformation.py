...
class TestsFlextTargetLdapTransformation:
    ...
    def test_transformation_engine_initialization(self) -> None:
        rules = [
    ...
    def test_transform_oracle_attributes_and_title_case(self) -> None:
    ...
    def test_full_oracle_migration_workflow(self) -> None:
        ...
        assert (
            transformed_entry["dn"] == "cn=john.doe,ou=people,dc=network,dc=invaliddc"
        )
